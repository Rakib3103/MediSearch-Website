...
<body>
<div class="topnav">
	<a class="active" href="LoginCustomer.html">Log in [Customer]</a>
...
<section class="login-sectionV js--login" id="login">
	...
	<div class="row">
		<form method="post" action="#" class="login-form">
			<div class="row">
				<div class="col span_1_of_3 login-label">
					<label for="email">Email</label>
				</div>
				<div class="col span_2_of_3">
					<input type="text" name="un" id="email" placeholder="Username" required>
				</div>
			</div>
      		<div class="row">
				<div class="col span_1_of_3 login-label">
				...
				<div class="col span_2_of_3">
					<input type="password" name="pw" id="password" placeholder="Your password" required>
				</div>
			</div>
