...
function random_num($length)
{
    ...
    $utype =   $_POST['address'];
      ...
      // $address= random_bytes(6);
			$query = "insert into dman (d_id,d_name,password,d_email,d_p_number,d_address) values ('$user_id','$user_name','$password','$email','$pnum','$utype')";
            ...
            <br>
              ...
              <form method='post'>
                ...
                <div>
                   ...
                   <a href="emlogin.php" class="de text-white">Click to Login</a>
                </div>
                 <br> 
